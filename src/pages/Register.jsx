...
export function Register(){
  ...
  return(
    <Container>
      <div className="flex flex-col items-center h-screen pb-3">
        ...
        <div className="flex flex-col items-center justify-center mt-32">
          ...
          >
            <input 
              type="email" 
              placeholder="E-mail" 
              className="h-16 rounded-2xl shadow-sm shadow-slate-300 text-black pl-6 placeholder:font-semibold placeholder:text-base placeholder:text-gray" 
              value={email} 
